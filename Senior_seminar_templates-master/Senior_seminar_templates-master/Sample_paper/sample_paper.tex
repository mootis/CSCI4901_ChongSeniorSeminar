...
\title{The Internet of Things Applied to Public Health}
...
\keywords{Internet of Things, Public health}
...
\section{Goals of the IoT}
\label{sec:goals}

\section{Implementation of the IoT}
...
\section{Conclusions and looking forward}
\label{sec:conclusions}

\section*{Acknowledgments}
\label{sec:acknowledgments}

I would like to thank K.K. Lambery and Elena Machkasova for their helpful insight and continuous feedback.
